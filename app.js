...
app.get("/",async (request,response)=>{
    try{
        ...
        response.render("home.ejs", {
            ...
            canonicalUrl: "https://www.encodeai.in/",
          
            // Social sharing
            ogImage: "https://www.encodeai.in/images/og-image.jpg",
            ...
            structuredData: JSON.stringify({
              ...
              "name": "EncodeAI",
              "url": "https://www.encodeai.in",
              "logo": "https://www.encodeai.in/images/logo.png",
              "sameAs": [
...
app.get('/sitemap.xml', async (req, res) => {
    try {
      ...
      const stream = new SitemapStream({ hostname: 'https://www.encodeai.in' });
